...
// void stadyState() {
//   unsigned long previousStadyState = 0;
//   const long intervalStadyState = 1000;  // หน่วงเวลา 1 วินาที
  
//   for (checkCount = 0; checkCount < 6; checkCount++) {
...
//       // ตรวจสอบสถานะและทำงานตามเงื่อนไขที่ต้องการ ทดสอบค่าแกว่งผ่าน Setting เป็นจำนวนครั้ง
//       if (Input >= Setpoint + 0.5) {
//         // ค่าอยู่ในช่วงที่กำหนด
//         // ทำการประมวลผลตามคำสั่งที่ต้องการ
//         STATUS_CHECK = false;
//         //Serial.println(STATUS_CHECK);
//       } else {
...
//   // สิ้นสุดการตรวจสอบ 6 ครั้ง
//   // ทำอะไรก็ตามที่ต้องการทำหลังจากการตรวจสอบ 6 ครั้ง
//   STATUS_CHECK = true;
//   //Serial.println(STATUS_CHECK);
// }
...
void stadyState() {
  ...
  // ตรวจสอบว่า checkCount เท่ากับ 6 หลังจากลูปทำงาน 6 ครั้ง
  if (checkCount == 6) {
    // ส่งค่า true หลังจากตรวจสอบครบ 6 ครั้ง
    STATUS_CHECK = true;
    //Serial.println(STATUS_CHECK);
  } else {
    // ส่งค่า false ถ้าไม่ครบ 6 ครั้ง
    STATUS_CHECK = false;
    //Serial.println(STATUS_CHECK);
  }
}
